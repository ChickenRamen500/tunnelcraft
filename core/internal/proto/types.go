...
// H1-H4 are strings so they can hold AWG2 numeric values ("123") as well
// as AWG3 range expressions ("0xff-0xffff", "[deadbeef]", "<12>", "{8}", "(6)", "t").
type AmneziaWGConfig struct {
        // Core WireGuard-like fields.
        PrivateKey   string `protobuf:"bytes,1,opt,name=private_key,json=privateKey,proto3" json:"private_key,omitempty"`
        PublicKey    string `protobuf:"bytes,2,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
        PresharedKey string `protobuf:"bytes,3,opt,name=preshared_key,json=presharedKey,proto3" json:"preshared_key,omitempty"`
        LocalAddress string `protobuf:"bytes,4,opt,name=local_address,json=localAddress,proto3" json:"local_address,omitempty"`
        ...
        // Junk packet parameters (AWG2 & AWG3).
        Jc   uint32 `protobuf:"varint,7,opt,name=jc,proto3" json:"jc,omitempty"`
        Jmin uint32 `protobuf:"varint,8,opt,name=jmin,proto3" json:"jmin,omitempty"`
        Jmax uint32 `protobuf:"varint,9,opt,name=jmax,proto3" json:"jmax,omitempty"`

        // Magic header sizes — S1/S2 for init packets, S3 for cookie response packets.
        S1 uint32 `protobuf:"varint,10,opt,name=s1,proto3" json:"s1,omitempty"`
        S2 uint32 `protobuf:"varint,11,opt,name=s2,proto3" json:"s2,omitempty"`
        S3 uint32 `protobuf:"varint,12,opt,name=s3,proto3" json:"s3,omitempty"`

        // Header transformation markers (strings to support both AWG2 numeric and AWG3 range syntax).
        // AWG2 examples: "1", "2"
        // AWG3 examples: "0xff-0xffff", "[deadbeef]", "<12>", "{8}", "(6)", "t"
        H1 string `protobuf:"bytes,13,opt,name=h1,proto3" json:"h1,omitempty"`
        H2 string `protobuf:"bytes,14,opt,name=h2,proto3" json:"h2,omitempty"`
        H3 string `protobuf:"bytes,15,opt,name=h3,proto3" json:"h3,omitempty"`
        H4 string `protobuf:"bytes,16,opt,name=h4,proto3" json:"h4,omitempty"`

        // AWG3-specific fields.
        HeaderProtectionKey    string `protobuf:"bytes,17,opt,name=header_protection_key,json=headerProtectionKey,proto3" json:"header_protection_key,omitempty"`
        ContentPaddingAddition string `protobuf:"bytes,18,opt,name=content_padding_addition,json=contentPaddingAddition,proto3" json:"content_padding_addition,omitempty"`

        // AWG3 timing fields (range strings, e.g. "120", "120-180").
        RekeyAfterTime      string `protobuf:"bytes,19,opt,name=rekey_after_time,json=rekeyAfterTime,proto3" json:"rekey_after_time,omitempty"`
        RekeyTimeout        string `protobuf:"bytes,20,opt,name=rekey_timeout,json=rekeyTimeout,proto3" json:"rekey_timeout,omitempty"`
        RejectAfterTime     string `protobuf:"bytes,21,opt,name=reject_after_time,json=rejectAfterTime,proto3" json:"reject_after_time,omitempty"`
        KeepaliveTimeout    string `protobuf:"bytes,22,opt,name=keepalive_timeout,json=keepaliveTimeout,proto3" json:"keepalive_timeout,omitempty"`
        MaxHandshakeAttempts string `protobuf:"bytes,23,opt,name=max_handshake_attempts,json=maxHandshakeAttempts,proto3" json:"max_handshake_attempts,omitempty"`
}
